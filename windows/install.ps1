...
# 3. Add to Windows startup (Registry Run key)
#
# Prerequisites:
...
Write-Host "[1/3] Building xkey in release mode..." -ForegroundColor Yellow
...
Write-Host "[2/3] Installing binary to $InstallDir..." -ForegroundColor Yellow
...
Write-Host "[3/3] Adding to Windows startup..." -ForegroundColor Yellow
Set-ItemProperty -Path $RegPath -Name $RegName -Value "`"$ExePath`""

Write-Host ""
Write-Host "=== Installation complete! ===" -ForegroundColor Green
Write-Host ""
Write-Host "XKey has been installed and will start automatically at login."
